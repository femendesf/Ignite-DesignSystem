...
import {
  ...
  rgba,
  withReset
} from "./chunk-6WMT3MGI.js";
import {
  ActionBar
} from "./chunk-7GXINLFV.js";
import {
  ThemeProvider,
  convert,
  ensure,
...
import {
  stringify
} from "./chunk-7TJ5JACP.js";
import {
  esm_default
} from "./chunk-6JVAWBCK.js";
import {
  require_uniq
} from "./chunk-P5L46KHL.js";
import {
  index_modern_default
} from "./chunk-RZFKJZML.js";
import {
  require_memoizerific
} from "./chunk-XSOMGSOU.js";
import {
  _extends,
...
import {
  require_pickBy
} from "./chunk-IAO5DWXV.js";
import {
  require_mapValues
} from "./chunk-ZEJGZDCR.js";
import {
  require_cloneDeep
} from "./chunk-UXWWOEG3.js";
import {
  require_client_logger
} from "./chunk-DSVN62JI.js";
import {
  require_react_dom
} from "./chunk-ZHCUIEE5.js";
import {
  scope
...
var Photo = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Images-S2WTXNGG-C4WO7HGR.js");
...
var Book = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Documents-SGWAY3KW-HQJ7GEDW.js");
...
var Markup = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Editing-7QFB6ZMG-NGPHQWNB.js");
...
var Repo = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Git-DZ2D5ZUL-OQITMUK4.js");
...
var Apple = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./OS-YZ2Y4VYS-7GZFZLFA.js");
...
var Storybook = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Logos-SJTNNI74-2OKUMWVZ.js");
...
var Browser = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Devices-SUYACUPO-PQK6H3P5.js");
...
var Edit = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./CRUD-I5EZL2FS-ONIYU7AZ.js");
...
var Info = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Communicate-7JXCND2Z-57WY4QGI.js");
...
var ChevronUp = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Wayfinding-BB4H7CHP-XX7VC23P.js");
...
var User = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./People-OD4EV7WZ-X7Q5TDJK.js");
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react27.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react27.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react27.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = scope, copyToClipboard = (0, import_react27.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-SJYYADS4.js");
...
var LazyColorControl = (0, import_react27.lazy)(() => import("./Color-6VNJS4EI-Z27N2RIZ.js"));
...
//# sourceMappingURL=chunk-P26XQICN.js.map
